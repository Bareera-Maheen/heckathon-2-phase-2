...
# Default to SQLite for immediate usage, but ready for Neon/Postgres
# To use Neon: SQLALCHEMY_DATABASE_URL = "postgresql://user:password@ep-xyz.region.aws.neon.tech/neondb?sslmode=require"
